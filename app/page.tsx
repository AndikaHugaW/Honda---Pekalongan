      ...
      <section className="py-24 bg-black relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            {/* Card 1 - CYLINDER CONFIGURATION */}
            <FadeIn direction="up" delay={0.2}>
              <motion.div
                className="relative bg-black border border-gray-700 rounded-lg p-8 h-full"
                whileHover={{ y: -4 }}
                transition={{ duration: 0.3 }}
              >
                {/* Background Icon */}
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-1 h-6 bg-red-500"></div>
                    <h3 className="text-sm font-bold text-white uppercase tracking-wider">CYLINDER CONFIGURATION</h3>
                  </div>
                  <p className="text-gray-300 leading-relaxed">
                    Setiap mesin Honda dirancang dengan konfigurasi silinder yang optimal untuk memberikan performa maksimal dan efisiensi bahan bakar terbaik dalam setiap perjalanan.
                  </p>
                </div>
              </motion.div>
            </FadeIn>
            ...
            <FadeIn direction="up" delay={0.3}>
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-1 h-6 bg-red-500"></div>
                    <h3 className="text-sm font-bold text-white uppercase tracking-wider">FUEL EFFICIENCY</h3>
                  </div>
                  <p className="text-gray-300 leading-relaxed">
                    Teknologi Honda yang canggih memastikan konsumsi bahan bakar yang lebih efisien tanpa mengorbankan performa, memberikan penghematan jangka panjang untuk pengguna.
                  </p>
                </div>
              </motion.div>
            </FadeIn>

            {/* Card 3 - MAX REVOLUTIONS */}
            <FadeIn direction="up" delay={0.4}>
              <motion.div
                className="relative bg-black border border-gray-700 rounded-lg p-8 h-full"
                whileHover={{ y: -4 }}
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-1 h-6 bg-red-500"></div>
                    <h3 className="text-sm font-bold text-white uppercase tracking-wider">MAX REVOLUTIONS</h3>
                  </div>
                  <p className="text-gray-300 leading-relaxed">
                    Mesin Honda dirancang untuk mencapai putaran maksimal yang optimal, memberikan akselerasi yang responsif dan performa tinggi dalam berbagai kondisi berkendara.
                  </p>
                </div>
              </motion.div>
            </FadeIn>
